...
<form id="jobApplicationForm" action="student_job_submission.php" method="post">
    <div class="form-group">
        <label for="jobTitle">Job Title</label>
        <input id="jobTitle" name="jobTitle" value="" required>
   ...
   <div class="form-group">
    ...
    <div class="form-group">
        <button type="submit"><a herf="student_job_submission.php">Submit Application</a></button>
    </div>
</form>
